sap.ui.define([
	...
	return BaseObject.extend("masterdata.MasterData.controller.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias masterdata.MasterData.controller.ListSelector
		 */
					...
					.then(function(oList) {
						oList.getBinding("items").attachEventOnce("dataReceived",
							function(oData) {
								...
								var selected = oList.data("selected");
								for (var i = 0; i < items.length; i++) {
									if (items[i].data("id") === selected) {
		 ...
		 * @public
		 */
		setBoundMasterList: function(oList, router) {
			this._oList = oList;
		 ...
		 * @return {masterdata.MasterData.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
